...
public class Encryption {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String encrypted = encryBpt(text, key);
    ...
    public static String encryBpt(String text, SecretKey key) throws Exception {
    ...
    public static String decrypt(String encryBpted, SecretKey key) throws Exception {
        Cipher ci = Cipher.getInstance(algo);
        ci.init(Cipher.DECRYPT_MODE, key);
        byte[] encryB = Base64.getDecoder().decode(encryBpted);
